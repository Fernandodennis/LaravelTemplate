 ...
 <form action="{{ route('user.store') }}" method="POST">
   ...
   <div class="border-b border-gray-900/10 pb-12">
     ...
     <div class="mt-10 col-span-full gap-y-8">
       <label for="id_suplier" class="block text-sm/6 font-medium text-gray-900">ID User</label>
         <div class="mt-2">
           <input id="id_user" name="id_user" type="id_user" autocomplete="id_user" value="{{ old('id_user') }}" required class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
         </div>
     </div>
     <div class="mt-5 col-span-full gap-y-8">
       <label for="nama" class="block text-sm/6 font-medium text-gray-900">Name</label>
         <div class="mt-2">
           <input id="nama" name="nama" type="nama" autocomplete="nama" value="{{ old('nama') }}" required class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
         </div>
     </div>
     <div class="mt-5 col-span-full gap-y-8">
       ...
       <div class="mt-5 col-span-full gap-y-8">
         ...
         <div class="mt-2">
           <textarea id="usernmae" name="username" rows="3" value="{{ old('username') }}" required class="block w-full rounded-md border-0 py-1.5 pl-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6"></textarea>
         </div>
       </div>
       <div class="mt-5 col-span-full gap-y-8">
